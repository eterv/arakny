...
<div class="ai-c max-w-900">
	...
	<table class="ui compact striped table list">
		...
		<tr data-id="<?= $item[M::u_id] ?>">
			<td>
				<div class="ui child checkbox">
					<input type="checkbox" name="cb" id="" value="<?= $item[M::u_id] ?>"><label for="">&nbsp;</label>
				</div>
			</td>
			<td class="data-name"><?= _e($item[M::u_name]) ?></td>
			<td class="data-title"><?= _e($item[M::u_email]) ?></td>
