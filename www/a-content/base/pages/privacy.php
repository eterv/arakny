...
<div class="page-content">
	...
	<div class="article-title">[ 개인정보 수집 및 이용 ]</div>
	...
	<table class="ui celled structured table">
		...
		<tbody>
		<tr>
			<td rowspan="2">가입, 서비스, 이용 및 상담, 부정이용 확인 및 방지 등</td>
			<td>성명, 연락처, ID, 비밀번호, 이메일</td>
			<td>회원 탈퇴 시까지</td>
		</tr>
		<tr>
			<td>서비스 이용기록(방문일시, IP 등), 기기정보(고유기기식별값, OS버전)</td>
			<td>회원 탈퇴 시까지</td>
		</tr>
		</tbody>
	</table>
	...
	<ol>
		<li>본 방침은 <?= $enforcementDate ?>부터 시행합니다.
	</ol>
