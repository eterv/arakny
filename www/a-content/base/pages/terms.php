...
/** 회사명 */
$companyName = getSetting(Settings::name);

/** 사이트 또는 쇼핑몰명 */
$siteName = $companyName;

/** 시행일 */
$enforcementDate = '2019년 1월 1일';

?>
<style>
	.page-content { line-height: 22px; word-break: keep-all; word-wrap: break-word; }
	.page-content .title { color: #0083B9; font-weight: bold; padding-bottom: 30px; }
	.page-content .article-title { color: #0083B9; font-weight: bold; padding-top: 30px; padding-bottom: 10px; }
	.page-content ul { margin: 0; padding: 0; list-style: none; font-weight:normal; }
	.page-content ol { margin-top: 0; margin-bottom: 0; }
	.page-content ol > li > ol > li {  list-style: disc; }
	.page-content p { margin: 0 0 15px; padding: 0; }
</style>
<div class="page-content">
	<div class="title">[ <?= $siteName ?> 이용 약관 ]</div>

	<div class="article-title" style="padding-top: 0;">제1조 목적</div>

	<p>이 약관은 <?= $companyName ?>(전자상거래 사업자로 이하 "회사"라 한다)가 운영하는 <?= $siteName ?>(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
	...
	<ol>
		<li>이 약관은 <?= $enforcementDate ?>부터 시행합니다.
